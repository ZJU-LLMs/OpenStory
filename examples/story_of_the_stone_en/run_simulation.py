...
os.environ["MAS_PROJECT_REL_PATH"] = "examples.story_of_the_stone_en"
...
from examples.story_of_the_stone_en.registry import RESOURCES_MAPS
...
async def main():
    ...
    try:
        ...
        from examples.story_of_the_stone_en.map.scripts.split_logs_by_character import process_log_directory
