...
os.environ["MAS_PROJECT_REL_PATH"] = "examples.story_of_the_stone"
...
from examples.story_of_the_stone.registry import RESOURCES_MAPS
from agentkernel_distributed.toolkit.logger import get_logger
from examples.story_of_the_stone.plugins.agent.plan.BasicPlanPlugin import BasicPlanPlugin
        ...
        async def launch_story():
            ...
            async with _story_launch_lock:
                ...
                _story_process = _subprocess.Popen(
                    [sys.executable, "-m", "examples.story_of_the_stone.story.run_simulation"],
                    cwd=project_root,
                )
