'python -m examples.story_of_the_stone.story.run_simulation'
...
os.environ["MAS_PROJECT_REL_PATH"] = "examples.story_of_the_stone.story"
...
from examples.story_of_the_stone.story.registry import RESOURCES_MAPS
...
async def main():
    ...
    from examples.story_of_the_stone.map.scripts.split_logs_by_character import process_log_directory
