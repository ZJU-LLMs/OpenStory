...
【重要约束】
1. 必须严格遵守《红楼梦》的时代背景与宗法礼制，注意长幼尊卑、主仆之别。
2. 人物情绪表达必须符合其身份与教养，大家族子弟应保持体面，即便冲突也应含蓄克制，绝不可出现现代式的撒泼、寻死觅活或极端暴力行为。
3. 仅当场景明确涉及武力或致命冲突时，才可在动作中客观描述"[XX重伤]"或"[XX死亡]"，日常家庭纠纷绝对禁止出现此类极端结果。
