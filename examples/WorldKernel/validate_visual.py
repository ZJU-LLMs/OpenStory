...
def main() -> int:
    ...
    summary = {
        ...
        "artifacts": {
            ...
            "road_atlas": str(spatial_root / "road_atlas.png"),
            "road_layer": str(spatial_root / "road_layer.png"),
            "road_prompt": str(spatial_root / "road_prompt.json"),
            "road_metadata": str(spatial_root / "road_metadata.json"),
